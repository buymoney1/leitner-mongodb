...
export default function VideoLevelsPage() {
  return (
    <div className="overflow-x-hidden"> 
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 py-8 px-4 sm:px-6 lg:px-8 relative">
        ...
        {/* Left Glow */}
        <div className="absolute top-1/4 left-0 -translate-x-1/2 w-72 h-72 bg-blue-500/10 rounded-full blur-3xl pointer-events-none"></div>

        {/* Right Glow */}
        <div className="absolute bottom-1/4 right-0 translate-x-1/2 w-72 h-72 bg-purple-500/10 rounded-full blur-3xl pointer-events-none"></div>

        <div className="relative z-10 max-w-7xl mx-auto">

          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-9">
            <div className="bg-gray-800/30 rounded-2xl p-4 border border-gray-700/50 backdrop-blur-sm text-center">
              <div className="text-xl font-bold text-cyan-400 mb-1">6</div>
              <div className="text-gray-400 text-sm">سطح مختلف</div>
            </div>
            <div className="bg-gray-800/30 rounded-2xl p-4 border border-gray-700/50 backdrop-blur-sm text-center">
              <div className="text-xl font-bold text-purple-400 mb-1">100+</div>
              <div className="text-gray-400 text-sm">ویدیو آموزشی</div>
            </div>
            <div className="bg-gray-800/30 rounded-2xl p-4 border border-gray-700/50 backdrop-blur-sm text-center">
              <div className="text-xl font-bold text-green-400 mb-1">1000+</div>
              <div className="text-gray-400 text-sm">زبان‌آموز فعال</div>
            </div>
            <div className="bg-gray-800/30 rounded-2xl p-4 border border-gray-700/50 backdrop-blur-sm text-center">
              <div className="text-xl font-bold text-orange-400 mb-1">95%</div>
              <div className="text-gray-400 text-sm">رضایت‌مندی</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {videoLevels.map((level) => (
              <Link key={level.level} href={`/videos-by-level/${level.level}`} className="group block">
                <div className="relative overflow-hidden rounded-2xl border border-gray-700/50 bg-gradient-to-br from-gray-800/50 to-gray-900/30 backdrop-blur-xl p-6 transition-all duration-500 group-hover:scale-105 group-hover:shadow-2xl h-full">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-white font-semibold text-lg">{level.title}</div>
                        </div>
                      </div>
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-700/50">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-400">شروع یادگیری</span>
          ...
          <div className="mt-16 mb-20 text-center">
            <div className="bg-gradient-to-r from-gray-800/50 to-gray-900/30 rounded-2xl p-8 border border-gray-700/50 backdrop-blur-sm">
              ...
              <button
                disabled
                className="text-sm disabled:bg-gray-500 disabled:cursor-not-allowed disabled:opacity-50 inline-flex items-center gap-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-6 py-2 rounded-xl transition-all duration-300 shadow-lg font-semibold"
              >
