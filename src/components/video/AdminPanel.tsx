...
export function AdminPanel() {
  ...
  return (
    <section className="mb-8 p-6 rounded-2xl bg-gradient-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-xl border border-gray-700/50 shadow-2xl relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(239,68,68,0.03)_50%,transparent_75%)] bg-[size:20px_20px]"></div>
      
      {/* Header */}
      <div className="relative z-10 flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-gradient-to-br from-red-500/20 to-pink-600/20 rounded-xl border border-red-500/30">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">دسترسی به ابزارهای مدیریتی پیشرفته</p>
          </div>
        </div>
        <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-red-500/10 border border-red-500/20 rounded-full">
          ...
          <span className="text-red-400 text-sm font-medium">دسترسی ادمین</span>
        </div>
      </div>
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {adminFeatures.map((feature, index) => (
          <Link key={index} href={feature.href} className="block group">
            <div className={`relative overflow-hidden rounded-xl border ${feature.borderColor} bg-gradient-to-br from-gray-800/50 to-gray-900/30 p-5 backdrop-blur-sm transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl h-full`}>
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="w-2 h-2 rounded-full bg-gradient-to-r from-gray-400 to-gray-600 group-hover:from-current group-hover:to-current transition-colors"></div>
                </div>
      ...
      <div className="relative z-10 mt-6 pt-4 border-t border-gray-700/50">
        <div className="flex flex-wrap items-center justify-between gap-4 text-xs text-gray-500">
          ...
          <span className="text-gray-400">دسترسی سطح ادمین</span>
        </div>
      </div>
    </section>
  );
